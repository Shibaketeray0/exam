...
class __TwigTemplate_9ab0cadf93fe103112f800f28de36e620f5af6a3eb10b482fe4fe7d5d068d144 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["description"] ?? null) && (twig_get_attribute($this->env, $this->source, ($context["description"] ?? null), "position", [], "any", false, false, true, 85) == "invisible"))) ? ("sr-only") : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/bootstrap/templates/bootstrap/bootstrap-panel.html.twig", "/var/www/drupal9/web/themes/contrib/bootstrap/templates/bootstrap/bootstrap-panel.html.twig");
    }
